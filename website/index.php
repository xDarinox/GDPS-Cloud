...
<head>
    ...
    <link rel="stylesheet" href="src/css/m_main.css">
    ...
    <header class="__header">
        <div class="__header-content">
            <span class="__header-logo">
                <img src="src/images/main/cloud.png" draggable="false" style="width: 2.75vh">
    ...
    <main>
        ...
        <footer class="footer-container">
            <section class="footer-column">
                ...
                <h5 id='site_version' class="service-disclaimer">Версия</h5>
                <div class="footer-links">
                    <a href="https://github.com/xDarinox/GDPS-Cloud" class="footer-link-button" target="_blank">
            ...
            <section class="footer-column">
                ...
                <a href="" class="footer-link" target="_blank">Тех. поддержка</a>
                <a href="" class="footer-link" target="_blank">Документация</a>
                <a href="" class="footer-link" target="_blank">FAQ</a>
            </section>

             <section class="footer-column">
                <h3 class="footer-column-title">GDPS CLOUD</h3>
                <a href="" class="footer-link" target="_blank">О нас</a>
                <a href="" class="footer-link" target="_blank">Правила использования</a>
